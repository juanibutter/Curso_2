...
def crearusuario():
    miconexion=sqlite3.connect("BBDD Usuarios de esta App")
    micursor=miconexion.cursor()
    micursor.execute("INSERT INTO Usuarios VALUES(NULL,'" + a_nombre.get() + 
    "','" + a_apellido.get() + 
    "','" + a_password.get() + 
    "','" + a_direccion.get() + 
...
def actualizarusuario():
    miconexion=sqlite3.connect("BBDD Usuarios de esta App")
    micursor=miconexion.cursor()
    micursor.execute("UPDATE Usuarios SET Nombre='" + a_nombre.get() + 
    "', Apellido='" + a_apellido.get() + 
    "', Password='" + a_password.get() + 
    "', Dirección='" + a_direccion.get() + 
